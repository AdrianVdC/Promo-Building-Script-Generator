# NATS Bonus Creator — Technical Reference v2.14
...
**Edit HIW / Edit T&Cs**
Hidden for RAF and SUO (copy pending legal approval or not applicable). Active for all other offer types.

**Edit Images**
Present for RTC CC, RTC FS, and RAF. Hidden for BG, DM, and SUO.
...
Applies to all six offer types including SUO.
