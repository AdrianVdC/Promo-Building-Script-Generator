...
- RTC CC / BG / BG-RE / DM / LC-REACT / LC-CHURN-DM: US (default), MI, WV, PA, NJ, ON, AB, CA
...
> ⚠️ This differs from all other offer types (BG, DM, RTC FS, RAF, SUO, LC-REACT, LC-CHURN-DM), which use a midnight-to-midnight (00:00:00 ET), 72-hour, or 10-day window.
...
Fully integrated into the HTML tool as of v2.15. See `Technical_Reference_v2_21.md` for full selector reference and Playmaker field spec.
