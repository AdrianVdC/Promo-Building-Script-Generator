# NATS Bonus Creator — Project Instructions (v3.2)
...
- `nats_bonus_creator_v3_2.html` — the tool (source of truth)
- `Technical_Reference_v3_0.md` — full selector reference, field specs, per-offer Script Steps, version history v2.17 → v3.0
- `Changelog_v3_2.md` — the release record (v3.0 → v3.2) (format tables, verification record, harness catches, coexistence notes)
