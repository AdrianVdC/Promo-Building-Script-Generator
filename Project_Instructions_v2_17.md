...
**Current live version:** `nats_bonus_creator_v2_17.html`
...
| Minimum Deposit | Dynamic from `M{min}` in the code |
...
Fully integrated into the HTML tool as of v2.15. See `Technical_Reference_v2_17.md` for full selector reference and Playmaker field spec.
