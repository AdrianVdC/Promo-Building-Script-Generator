...
### Image Filenames
All offer types use: `Promo Detail.png`, `Masthead.png` — **with one exception: VIPBG CA (v2.27) uses category-specific `{Slots|Tables} Promo Detail.png` / `{Slots|Tables} Masthead.png` instead** (see below).
...
Fully integrated into the HTML tool as of v2.15. See `Technical_Reference_v2_27.md` for full selector reference and Playmaker field spec.
