# NATS Bonus Creator — Technical Reference v2.32
...
Available games as of v2.32: **TCE** (Triple Cash Eruption, IGT/IGT_Rgs), **7FH** (7's Fire Blitz™ Hotstepper, WHG/WHITEHATSTUDIOS), **7H2** (7's Fire Blitz™ Hotstepper 2, WHG/WHITEHATSTUDIOS — added v2.32), **7P5** (7's Fire Blitz™ Power 5 Jackpot Royale™ Express, WHG/WHITEHATSTUDIOS), **WWE** (WrestleMania™: Road to Gold, WHG/WHITEHATSTUDIOS). The full table with deeplinks and search names lives in the project instructions. Note 7FH and 7H2 share the typed search string `7's Fire Blitz` — disambiguation is entirely in the anchored match step, which is why the anchoring (and the required jurisdiction suffix) is load-bearing.
